...
Route::post('/users/{user}', [UserController::class, 'show']) ->name('users.show'); //rota retornar um usuario especifico
Route::post('/users/{user}/edit', [UserController::class, 'edit']) ->name('users.edit'); //rota para formulario editar o usuario
